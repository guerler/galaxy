...
import { faChartBar, faFolderOpen, faPause, faPencilAlt, faSitemap, faWrench } from "@fortawesome/free-solid-svg-icons";

library.add(faChartBar, faWrench, faFile, faSitemap, faPencilAlt, faPause, faFolderOpen);
