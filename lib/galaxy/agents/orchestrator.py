...
class WorkflowOrchestratorAgent(BaseGalaxyAgent):
    ...
    async def process(self, query: str, context: Optional[dict[str, Any]] = None) -> AgentResponse:
        ...
        try:
            ...
            if visualizations and self._is_visualization_query(query, visualizations):
    ...
    def _is_visualization_query(self, query: str, visualizations: list[dict]) -> bool:
        """Check if the query is about visualization or mentions a known plugin."""
