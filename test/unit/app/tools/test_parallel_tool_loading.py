...
TOOL_TEMPLATE = string.Template(
    """<tool id="${tool_id}" name="Test Tool ${tool_id}" version="1.0" profile="16.01">
...
class TestParallelToolLoading(BaseToolBoxTestCase):
    ...
    def _load_tools_serial(self):
        ...
        self.app.config.parallel_tool_loading = False
    ...
    def _load_tools_parallel(self, workers=2):
        ...
        self.app.config.parallel_tool_loading_workers = workers
        return set(self.toolbox._tools_by_id.keys())
